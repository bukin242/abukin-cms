...
switch($requestVars['action'])
{
    ...
    case 'refresh':
        ...
        $captchaCodes = array(
            'star'    => md5(mt_rand(00000000, 99999999)),
        ...
        {
            echo '<a href="#" class="captchaRefresh"></a><div id="draggable_' . $captchaCodes[$captchaImage['label']] . '"
            class="draggable" style="left: ' . (($count * 68) + 15) . 'px; background-position: ' . $captchaImage['on']['top'] . ' ' . $captchaImage['on']['left'] . ';"></div>';

        }

        echo '<div class="targetWrapper"><div class="target" style="background-position: ' . $captchaImages[$randomCaptcha]['off']['top'] . ' ' . $captchaImages[$randomCaptcha]['off']['left'] . ';"></div></div>
